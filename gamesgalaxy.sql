...
(38, 42, 1, 'This is the best Assassin&#039;s Creed', '2023-12-30 00:47:52');
...
INSERT INTO `friends` (`id`, `u1_id`, `u2_id`) VALUES
(2, 1, 3),
(3, 2, 3);
...
INSERT INTO `messages` (`id`, `sender_id`, `receiver_id`, `message`, `date_time`) VALUES
(1, 1, 3, 'Yo', '2023-12-30 09:49:25'),
(2, 3, 1, 'Yo Yo', '2023-12-30 09:49:48'),
(3, 3, 1, 'testing messages', '2023-12-30 10:22:29'),
(31, 3, 1, 'test notifications', '2024-01-02 17:04:06'),
(32, 1, 3, 'testing too', '2024-01-02 17:04:20'),
(43, 3, 1, 'test', '2024-01-02 18:09:47'),
(44, 3, 1, 'test', '2024-01-02 18:11:23');
...
CREATE TABLE `notifications` (
  ...
  `type` enum('friend_request','message','accepted_request') DEFAULT NULL,
...
ALTER TABLE `friend_request`
  ADD PRIMARY KEY (`id`),
  ADD KEY `u1_id` (`sender_id`),
  ADD KEY `u2_id` (`receiver_id`);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `user` (`id`);
