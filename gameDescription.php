                ...
                <div class="comments">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="comment_likes" >
                            ...
                            echo '
                                <svg id="like-' . $commentID . '" data-comment-id="' . $commentID  . '" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up';
                            if ($hasLiked) {
                                echo ' liked';
                            }
                            ...
                            echo '
                                <p id="like-count-' . $commentID . '" class="comment_like_text">' . $likes . '</p>
                            </div>
                            <div  class="comment_dislike" >';
                            echo '
                                <svg id="dislike-' . $commentID . '" data-comment-id="' . $commentID  . '" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down';
                            if ($hasDisliked) {
                                echo ' disliked';
                            }
                            echo '" viewBox="0 0 16 16">
                            ...
                            // }
                            echo
                            '<p id="dislike-count-' . $commentID . '" class="comment_dislike_text">' . $dislikes . '</p>
                            </div>';
                            if ($username == $_SESSION['username']) {
                                ...
                                <div class="comment_delete" >
                                    <svg style="position:relative; top:-25px" data-comment-id="' . $commentID  . '" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi deleteComment bi-trash3" viewBox="0 0 16 16">
