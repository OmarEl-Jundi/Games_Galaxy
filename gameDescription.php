                ...
                <div class="comments">
                    ...
                    <div class="comment_form">
                        <div action="commentProcess.php" method="POST">
                            ...
                            <button onclick="commentProcess()" id="submitComment" style="padding: 8px 15px; border-radius: 5px; background-color: #007bff; color: #fff; border: none;margin-top:5px;">Submit The Comment</button>
                        </div>
                    </div>
                    <hr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn close_editComment_Alt close-btn btn-default" data-dismiss="modal">Close</button>
